...
export const categories = [
  {
    ...
    locales: {
      en: {
        ...
        cardDescription: 'Equipment for agricultural operations, field-related work, material handling, preparation tasks and support systems around farm and production activity.',
  ...
  },
  {
    ...
    locales: {
      en: {
        ...
        cardDescription: 'Equipment and systems for reception, cleaning, conveying, elevation, storage-adjacent handling and grain flow requirements.',
        cardCtaLabel: 'View category',
  ...
  },
  {
    ...
    locales: {
      en: {
        ...
        cardDescription: 'Equipment for food production environments, preparation stages, processing workflows, handling steps and production line support.',
        cardCtaLabel: 'View category',
