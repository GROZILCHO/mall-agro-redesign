...
| ISS-021 | English category placeholder pages are not ready for indexable SEO metadata. | Open | DEC-009 approves temporary `noindex` for `/products/agriculture`, `/products/grain-processing`, and `/products/food-industry-equipment`. Source implementation is pending. |
