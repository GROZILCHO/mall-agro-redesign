...
| ISS-023 | Route-pair mapping for cross-domain language switch is not defined. | Open | Route-pair mapping policy is documented at planning level. Fallback behavior remains open, and source implementation is still pending. |
